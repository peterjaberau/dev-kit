...
const StvtFiltersMenu = React.memo((props: any) => (
  <Box p="10px">Filters Menu Placeholder</Box>
));
const StvtSearch = React.memo((props: any) => (
  <Box p="10px">Search Bar Placeholder</Box>
));
  ...
  return (
    ...
    >
      ...
      >
        ...
        <StvtFiltersMenu
          filters={filters}
          onFiltersSelected={handleFiltersChange}
        />
      </Box>
              ...
              >
                ...
                <PopoverBody p={4} fontSize="sm">
                  <Text mb={2}>
                    ...
                    object styles, animation, etc. — represented as data.
                    These can represent anything defined by design: a color as
                    a RGB value, an opacity as a number, an animation ease as
                    Bezier coordinates. They’re used in place of hard-coded
                    values in order to ensure flexibility and unity across all
                    product experiences.
                  </Text>
                  <Text mb={2}>
                    ...
                    component states, and more. We also offer teams a variety
                    of token types to use directly within their products if they
