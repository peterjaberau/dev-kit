...
<ComponentPreview styleName="base-nova" name="p-file-upload-1" />
...
```bash
npx shadcn@latest add @reui/file-upload
```
...
<ComponentPreview styleName="base-nova" name="p-file-upload-2" />

### Compact Upload

<ComponentPreview styleName="base-nova" name="p-file-upload-3" />
