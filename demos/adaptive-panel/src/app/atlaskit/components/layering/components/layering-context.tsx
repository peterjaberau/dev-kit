import React, { createContext, type FC, type RefObject, type ReactNode, useContext, useEffect, useRef } from "react"
 ...
 */
export const LevelNodeContext: React.Context<React.RefObject<LayerNode | null>> = createContext<RefObject<LayerNode | null>>({
  current: null,
})
 ...
 * Default ref value is null
 */
export const RootNodeContext: React.Context<React.RefObject<LayerNode | null>> = createContext<RefObject<LayerNode | null>>({
  current: null,
})
