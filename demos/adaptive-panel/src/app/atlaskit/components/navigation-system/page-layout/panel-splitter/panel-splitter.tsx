...
import { forwardRef, type ReactNode, useCallback, useContext, useEffect, useMemo, useRef, useState, useId } from "react"

import { bind } from 'bind-event-listener';
import { createPortal } from 'react-dom';
import invariant from 'tiny-invariant';

import { noop, useStableRef } from "#atlaskit/ds-lib"
...
const PortaledPanelSplitter = ({
    ...
    <chakra.div
      css={{
        ...
        ...(position === "start" ? containerStyles.positionStart : undefined),
        ...(position === "end" ? containerStyles.positionEnd : undefined),
      }}
    >
      <chakra.div
        ref={splitterRef}
      ...
      >
        <VisuallyHidden>
          ...
          />
          <chakra.span id={labelId}>{label}</chakra.span>
        </VisuallyHidden>
        <chakra.span css={lineStyles.root} />
      </chakra.div>
    </chakra.div>,
    portal,
  )
