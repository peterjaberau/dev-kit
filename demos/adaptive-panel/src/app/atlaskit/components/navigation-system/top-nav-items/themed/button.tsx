...
import { mergeRefs, forwardRefWithGeneric } from "#atlaskit/ds-lib"
...
interface CommonProps {
   ...
   */
  appearance?: "solid" | "subtle" | "surface" | "outline" | "ghost" | "plain"
  /**
 ...
 */
const ThemedPressable = forwardRef<HTMLButtonElement, any>(function ThemedPressable(
	{ appearance = 'solid', shape = 'default', isSelected, isDisabled, ...props },
	ref,
) {
