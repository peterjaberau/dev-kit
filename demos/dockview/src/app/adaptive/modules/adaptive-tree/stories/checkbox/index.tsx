...
const TreeNodeCheckbox = (props: AdaptiveTree.NodeCheckboxProps) => {
...
const Index = () => {
  return (
    <AdaptiveTree.Root collection={collection} maxW="sm" defaultCheckedValue={[]}>
      <AdaptiveTree.Label>Tree</AdaptiveTree.Label>
      <AdaptiveTree.Tree>
        <AdaptiveTree.Node
          render={({ node, nodeState }) =>
            nodeState.isBranch ? (
              <AdaptiveTree.BranchControl role="none">
                <TreeNodeCheckbox />
                <LuFolder />
