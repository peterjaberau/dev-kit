...
export const ExamplePreview = forwardRef((props: any, ref: any) => {
  const { children, css, ...rest } = props
  return (
    <div
      data-scope="example-preview"
      className="_2rko12b0 _1h6d1l7x _189ee4h9 _1dqonqa1 _1bsbnklw _bfhkvuon"
      ref={ref}
    />
  )
})
