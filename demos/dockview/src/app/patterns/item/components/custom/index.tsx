...
import { itemRecipe } from "./custom-item-slot-recipe"
  ...
  (
    ...
    return (
      <chakra.div
        ...
        {...rest}
      >
        {icon && <chakra.div css={styles.icon}>{icon === "checkbox" ? <CheckIcon /> : icon}</chakra.div>}
        ...
        {description && <chakra.div css={styles.description}>{description}</chakra.div>}

        {suffix && <chakra.div css={styles.suffix}>{suffix}</chakra.div>}

        {rightIcon && <chakra.div css={styles.rightIcon}>{rightIcon}</chakra.div>}
