...
import { EditorView, TransactionSpec, useCodeMirror, ViewUpdate } from "@uiw/react-codemirror"
...
type CodeEditorDefaultProps = Required<Omit<CodeEditorProps, "content" | "onChange" | "onUpdate">>
