    ...
    return (
      <div
        ...
        className={clsx([
          ...
          isDragging && indicator && 'itemDraggingIndicator',
          isDragging && isSorting && 'itemGhostSorting',
          clone && 'itemClone',
          "dnd-tree-item",
      ...
      >
        <div
          ...
          className={clsx(
            'itemContainer',
            isDragging && indicator && 'itemContainerGhostIndicator',
            clone && 'itemContainerClone',
            "dnd-tree-item-container",
            clone && "dnd-tree-item-container-clone",
            isDragging && indicator && "dnd-tree-item-container-indicator",
            itemProjected?.canMove === false && 'itemContainerGhostIndicatorCannotMove',
          )}
        >
          <div className={clsx('itemActions', "dnd-tree-item-actions")}>
            ...
            {onCollapse && (
              <Action
                ...
                className={clsx([
                  'itemActionCollapse',
                  node.collapsed && node.children.length > 0 && 'itemActionCollapsed',
          ...
          <div className={clsx('itemContent', "dnd-tree-item-content")}>
          ...
          {clone && childCount && childCount > 1 ? (
            <div className={clsx('itemChildrenCount', "dnd-tree-item-children-count")}>
              {childCount}
            </div>
          ) : null}
        </div>
