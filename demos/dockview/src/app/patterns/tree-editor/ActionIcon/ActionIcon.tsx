...
/**
 * @title Action icon properties
 * @description inherits all attributes from the 'Button' component, except for 'title', 'type' and 'size'
...
const BaseActionIcon: FC<ActionIconProps> = ({
  ...
  const { styles, cx }: any = useStyles({ size });
