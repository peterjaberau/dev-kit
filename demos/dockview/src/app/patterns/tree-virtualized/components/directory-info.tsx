...
export const DirectoryInfo = () => {
  ...
  return (
    <div className="p-4 flex flex-col gap-4 border rounded shadow-sm">
      ...
      <pre className="max-h-[300px] text-xs font-mono bg-zinc-100 dark:bg-zinc-950 p-4 rounded-md overflow-auto border border-zinc-200 dark:border-zinc-800">
        {
          JSON.stringify({
            search: searchQuery,
            mode: viewMode,
      ...
      <div>
        ...
        <ul className="pl-4 text-sm list-disc">
          ...
          <li><strong>Load Test:</strong> Added a folder with 10000 items to demonstrate speed.</li>
