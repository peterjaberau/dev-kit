  ...
  const interactiveElemContent = (
    <chakra.div css={interactiveContentStyles.root}>
      ...
      <chakra.div
        ...
        aria-hidden="true"
      />
      <chakra.div css={[textStyles.root, !showElemBefore && textStyles.noElemBeforeIndent]}>
    ...
    <Avatar.Root>
      ...
      >
        {isLink ? (
          ...
          >
            <chakra.div css={notchStyles.root} aria-hidden="true" />
...
// ) => React.ReactElement | null = forwardRef(MenuItemBaseNoRef);

export const MenuItemBase = forwardRef(MenuItemBaseNoRef) as <T extends HTMLAnchorElement | HTMLButtonElement>(
  props: MenuItemBaseProps<T> & React.RefAttributes<T>,
