...
import { Layering,  } from '#atlas-ui/layering';
import { useNotifyOpenLayerObserver } from '#atlas-ui/layering/entry-points/experimental/open-layer-observer';
import { Manager, Reference } from '#atlas-ui/poper';
...
export const PopupContent = ({
	...
	return <Portal>{popperWrapper}</Portal>;
};
