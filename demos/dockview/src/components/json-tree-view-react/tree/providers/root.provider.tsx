...
export const RootProvider = forwardRef<HTMLDivElement, any>((props, ref) => {
  const [{ value: componentValue }, localProps] = splitRootProviderProps(props, ['value'])
  const mergedProps = mergeProps(componentValue.getRootProps(), localProps)

  return (
    <Provider value={componentValue}>
