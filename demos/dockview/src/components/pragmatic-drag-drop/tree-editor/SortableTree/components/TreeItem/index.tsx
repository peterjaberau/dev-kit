...
import { CollapseAction, DeleteAction, HandleAction } from '#components/pragmatic-drag-drop/tree-editor/ActionIcon';
...
const useStyles = createStyles(
  ({ css, cx, prefixCls, token }: any, { collapsed }: { collapsed: boolean }) => {
...
const TreeItem: FC<TreeItemProps> = memo(
  ({
    ...
    const { styles, cx } = useStyles({ collapsed } as any);
