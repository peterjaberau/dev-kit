...
import { DropIndicator } from '#components/pragmatic-drag-drop/tree/components/dnd-drop-indicator';
...
function FilterList({ filters }: { filters: TFilter[] }) {
	...
	return (
		<DropIndicator.Group isActive={state === 'is-innermost-over'} ref={ref}>
			{filters.map((filter) => (
