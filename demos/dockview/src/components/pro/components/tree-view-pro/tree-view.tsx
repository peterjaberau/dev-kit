...
import { TreeView as ArkTreeView, type TreeNode, useTreeViewContext } from "./base"
...
export interface TreeViewRootProviderBaseProps
  extends Assign<ArkTreeView.RootProviderBaseProps<TreeNode>, SlotRecipeProps<"treeView">>,
    UnstyledProp {}
...
export interface TreeViewRootBaseProps
  extends Assign<ArkTreeView.RootBaseProps<TreeNode>, SlotRecipeProps<"treeView">>,
    UnstyledProp {}
  ...
  return (
    <>
      {tree.collection
        ...
        .map((node: any, index: any) => renderNode(node as T, [index]))}
    </>
  )
}
