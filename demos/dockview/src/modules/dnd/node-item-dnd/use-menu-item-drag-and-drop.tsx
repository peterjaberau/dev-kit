...
import { DropIndicator } from "../drop-indicator/list-item"

/**
 * - internal states: 'idle' | 'preview' | 'dragging' | 'is-over'
 * - dnd states: 'idle' | 'preview' | 'dragging' | 'is-over'
 */

const idle: any = { type: "idle" }
