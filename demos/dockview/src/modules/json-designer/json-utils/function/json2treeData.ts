/**
 * * json2treeData: Converts the current JSON data into treeData (for use by Ant Design's TreeSelect).
 *  * 【Method Parameter Description】
 *  * mockData: JSON data, required.
...
/**
 *  Convert mockData to treeData (for use by Ant Design's TreeSelect)
 * */
