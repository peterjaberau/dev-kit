...
import { DropTargetProps } from "./types"
 ...
 * ```tsx
 * // List mode (for items)
 * <DropTarget id="item-1" mode="list-item" onDrop={handleDrop}>
 *   <Item />
 * </DropTarget>
 *
 * // Group mode (for flat list)
 * <DropTarget id="item-1" mode="group" onDrop={handleDrop}>
 *   <Item />
 * </DropTarget>
 *
 * // Tree mode (for complex)
 * <DropTarget id="item-1" mode="tree-item" currentLevel={1} onDrop={handleDrop}>
 *   <Item />
 * </DropTarget>
 * ```
 */
...
export const DropTarget = ({
  ...
  useEffect(() => {
    return subscribeActiveTarget(({ element }: any) => {
