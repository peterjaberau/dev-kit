...
export const tree: any = {
  ...
  insertBefore(data: any[], targetId: string, newItem: any) {
  ...
  insertAfter(data: any[], targetId: string, newItem: any) {
    return data.flatMap((item) => {
      if (item.id === targetId) {
        return [item, newItem]
      }
  ...
  insertChild(data: any[], targetId: string, newItem: any) {
    return data.flatMap((item) => {
      if (item.id === targetId) {
...
export function treeStateReducer(state: any, action: any) {
  return {
...
function getChildItems(data: any[], targetId: string) {
  /**
