...
import { SIDEBAR_WIDTH_PX_MAX, SIDEBAR_WIDTH_PX_MIN } from "../../lib/contants"
import { sideBarWidthAtom } from "../../packages/atoms/ui/views"
...
const clampSidebarWidth = (value: number) => Math.min(SIDEBAR_WIDTH_PX_MAX, Math.max(SIDEBAR_WIDTH_PX_MIN, value))
