export const data = {
  ...
  ably: {
    ...
    components: {
      ...
      securitySchemes: {
        bearer_auth: {
          description:
            'Control API uses bearer authentication. You need to generate an access token for use with this API. More details can be found in the <a href="https://ably.com/documentation/control-api/#authentication">Ably documentation</a>.',
          scheme: "bearer",
          type: "http",
        },
      },
  ...
  "callbacks-weird-summary-description": {
    openapi: "3.0.3",
    info: {
      title: "Support for callbacks",
      description:
        ...
        conditionFieldDependency: {
          ...
          oneOf: [
            ...
            },
            {
              ...
              type: "object",
              description:
                "Evaluates the controlling field's value and the static args using the operator. When evaluating, the first argument of the operator call must be the dynamic value of the controlling field, e.g. `isEqual(controllingFieldValue, ...resolver.args)`.\n",
            },
          ],
        },
      },
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    fields: {
                      ...
                      items: {
                        ...
                        properties: {
                          key: {
                            description:
                              "The key used to store what the user entered It must be only one word, e.g. space and dash are not allowed\n",
                            type: "string",
                          },
                          label: {
                            ...
                            oneOf: [
                              {
                                ...
                                properties: {
                                  include_time: {
                                    description:
                                      "Adds a time field which must be converted to UTC before being sent to the server",
                                    type: "boolean",
                                  },
                                },
                              },
                              {
                                title: "empty",
                                description:
                                  "`currency`, `date-range`, `email`, `html`, `number` have no configuration\n",
                                example: {},
                                type: "object",
                                additionalProperties: false,
                                properties: {},
                              ...
                              },
                              {
                                ...
                                properties: {
                                  values: {
                                    description:
                                      "An array of objects describing the list of possible values. Can only be `[]` if an autocomplete plugin is applied.\n",
                                    type: "array",
                                    items: {
                                      type: "object",
                                      ...
                                      properties: {
                                        key: {
                                          description:
                                            "This key helps the server determine whether this value was renamed or deleted during PUT.",
                                          type: "string",
                                        },
                                        label: {
                              ...
                              },
                              {
                                ...
                                properties: {
                                  ...
                                  parent_term_ids: {
                                    description:
                                      "Limit the tree(s) of terms to choose from.\nIf empty, any terms can be applied\n",
                                    items: {
                                      type: "string",
                                ...
                                properties: {
                                  ...
                                  sub_schema: {
                                    ...
                                    properties: {
                                      fields: {
                                        description:
                                          "This follows the same fields array at the root of the schema with the exception that fields of type `object-array` cannot be nested.\n",
                                        type: "array",
                                        items: {
                                          type: "object",
                                        },
                    ...
                    fieldsets: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          field_keys: {
                            description:
                              "An ordered list of field keys displayed inside the fieldset. The keys must match the `key` value in the `fields` array.\n",
                            type: "array",
                            items: {
                              type: "string",
                            },
                    ...
                    plugins: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          key: {
                            description:
                              "The key used to store plugin information. Can be `null` for plugins that don't need to store data.\n",
                            type: "string",
                            nullable: true,
                          },
                          type: {
                            ...
                            oneOf: [
                              ...
                              },
                              {
                                ...
                                properties: {
                                  timezones: {
                                    description:
                                      "Restricts the list of timezones a user can select. If empty, the form will use the device's current timezone.\n",
                                    type: "array",
                                    items: {
                                      title: "timezone",
                                      description:
                                        "A timezone name from the [tz database](http://en.wikipedia.org/wiki/List_of_tz_database_time_zones). Timezone abbreviations (eg. EST) are *not* supported.\n",
                                      type: "string",
                                    },
                                  },
                                },
                    ...
                    conditions: {
                      ...
                      title: "Conditions",
                      description:
                        "A set of conditions that define field dependencies or cascading values for the schema.\n",
                      type: "array",
                    },
                    platform_ids: {
                      items: {
                      ...
                      type: "array",
                      description:
                        "An array of platform IDs the schema applies to. Send `null` if the schema applies to all platforms.\n",
                      nullable: true,
                    },
                  },
                },
  ...
  "operation-examples": {
    ...
    paths: {
      "/examples-at-mediaType-level": {
        post: {
          description:
            "This operation has no requestBody or response schemas, but has curated examples within `examples` at the mediaType level.",
          requestBody: {
            required: true,
            content: {
              "application/json": {
      ...
      "/single-media-type-single-example-in-example-prop-thats-a-string": {
        post: {
          description:
            "This operation handles a single media type with single request and response example that's a string.",
          requestBody: {
            required: true,
            content: {
              "application/json": {
      ...
      "/single-media-type-single-example-in-examples-prop-that-are-strings": {
        post: {
          description:
            "This operation handles a single media type with single example in an `examples` property that's a string.",
          requestBody: {
            required: true,
            content: {
              "application/json": {
      ...
      "/single-media-type-single-example-in-examples-prop-that-are-arrays": {
        post: {
          description:
            "This operation handles a single media type with single example in an `examples` property that are arrays.",
          requestBody: {
            required: true,
            content: {
              "application/json": {
      ...
      "/similarly-named-type-example": {
        post: {
          description:
            "This schema has two `type` properties, each with their own example. They should retain those separate examples.",
          requestBody: {
            content: {
              "application/json": {
                schema: {
  ...
  "path-matching-quirks": {
    ...
    info: {
      ...
      description:
        "Example API definition to cover some quirks with path matching where a query param in a path might break `Oas.findOperation()`",
      version: "1.0",
    },
    servers: [
      {
    ...
    paths: {
      ...
      "/games/{game}/dlc/{dlcrelease}}": {
        get: {
          description:
            "This operation is us asserting that we're able to match against a path with a malformed path parameter.",
          parameters: [
            {
              schema: { type: "string" },
              name: "game",
      ...
      "/games/{game}/platforms/{platform}/dlc/{dlc-release}": {
        get: {
          description:
            "This operation is asserting that we're able to match against a path that has a path parameter that contains a hyphen.",
          parameters: [
            {
              schema: { type: "string" },
              name: "game",
  ...
  "pathitems-component": {
    ...
    info: {
      ...
      title: "Single Path",
      description:
        "This is a slimmed down single path version of the Petstore definition that uses `pathItems` components.",
    },
    servers: [
      {
        url: "https://httpbin.org/anything",
  ...
  "polymorphism-with-circular-ref": {
    openapi: "3.0.1",
    info: {
    ...
    components: {
      schemas: {
        AccountLoginResponseModel: {
          ...
          properties: {
            ...
            token: {
              type: "string",
              description:
                "Gets the JWT token response that must be inclued in the header of all API requests. Add it to the Authorization header prefaced by Bearer.",
              nullable: true,
            },
            refreshToken: {
              type: "string",
        ...
        AdBreakModel: {
          ...
          properties: {
            ...
            adBreakType: {
              ...
              description:
                "The type of the ad break (pre-roll, post-roll, mid-roll)\r\n\r\nPreroll\r\n\r\nMidroll\r\n\r\nPostroll",
              "x-enumNames": ["Preroll", "Midroll", "Postroll"],
            },
            tags: {
              type: "array",
              items: {
        ...
        AddScheduleModel: {
          ...
          properties: {
            ...
            scheduleType: {
              ...
              description: "\r\n\r\nPlaylist\r\n\r\nIntelligentSchedule\r\n\r\nIntelligentPlaylist",
              "x-enumNames": ["Playlist", "IntelligentSchedule", "IntelligentPlaylist"],
            },
            timeZoneId: {
              type: "string",
              format: "uuid",
        ...
        AssetModel: {
          ...
          properties: {
            ...
            assetType: {
              ...
              description: "\r\n\r\nFolder\r\n\r\nFile\r\n\r\nBucket",
              "x-enumNames": ["Folder", "File", "Bucket"],
            },
          },
          additionalProperties: false,
        },
        AssetPartUploadModel: {
          ...
          properties: {
            ...
            url: {
              type: "string",
              description:
                "The URL that can be used to upload TO. This is meant to be a partial file upload location and will expire.",
              nullable: true,
            },
            partNumber: {
              type: "integer",
        ...
        AssetUploadStartRequestModel: {
          ...
          properties: {
            ...
            relatedAssetId: {
              type: "string",
              description:
                "The related asset ID of the existingAsset that we're replacing. If this is used, most of the other properties are not needed.",
              format: "uuid",
              nullable: true,
            },
            relatedContentId: {
            ...
            parentId: {
              type: "string",
              description:
                "The Parent AssetId (folder) to add the upload to. Note that if there is a full relativePath, then it is appended to this parent path. If this value is omitted then the file will be added to the predefined incoming folder.\r\nThis is ignored if the ExistingAssetId or if the RelatedContentId has a value",
              format: "uuid",
              nullable: true,
            },
            relativePath: {
              type: "string",
              description:
                "The filename to upload - or a full path with the filename at the end.\r\nThis is ignored if the ExistingAssetId or if the RelatedContentId has a value",
              nullable: true,
            },
            languageId: {
              type: "string",
            ...
            displayName: {
              type: "string",
              description:
                "The display name of the file to upload (does not include the path) and must include the file extension\r\nThis is ignored if the ExistingAssetId has a value",
              nullable: true,
            },
            contentLength: {
              type: "integer",
            ...
            chunkSize: {
              type: "integer",
              description:
                "The size of the upload chunks. This should be adjusted to optimize the upload size based on the user's internet connection.",
              format: "int64",
            },
            uploadOverwriteOption: {
              ...
              description:
                "If the file already exists on the server, this decides how to handle the situation\r\n\r\nCancel\r\n\r\nContinue\r\n\r\nReplace",
              "x-enumNames": ["Cancel", "Continue", "Replace"],
            },
            properties: {
              type: "object",
              additionalProperties: {},
        ...
        ChangeAssetPropertiesModel: {
          ...
          properties: {
            ...
            customProperties: {
              ...
              additionalProperties: {},
              description:
                "A list of custom properties that should be saved for the asset. To remove a property value, set the value to null",
              nullable: true,
            },
          },
          additionalProperties: false,
        ...
        CloudFrontDistributions: {
          enum: ["Content", "PublicApi", "RestrictedContent"],
          type: "string",
          description: "\r\n\r\nContent\r\n\r\nPublicApi\r\n\r\nRestrictedContent",
          "x-enumNames": ["Content", "PublicApi", "RestrictedContent"],
        },
        CollectionContentModel: {
          ...
          properties: {
            ...
            createNew: {
              type: "boolean",
              description:
                "Defaults to True. If true, then the attribute will be added if it doesn't already exist with a matching name",
            },
            collectionId: {
              type: "string",
            ...
            name: {
              type: "string",
              description:
                "The name of the collection that should be added or removed. If the name and the collectionId are both specified, the name is ignored.",
              nullable: true,
            },
            childId: {
              type: "string",
        ...
        ConfigTypes: {
          ...
          description: "\r\n\r\n1 = Admin\r\n\r\n2 = Lambda\r\n\r\n3 = Groundtruth",
          format: "int32",
          "x-enumNames": ["Admin", "Lambda", "Groundtruth"],
        },
        ...
        ContentLanguageStatuses: {
          enum: ["Original", "Override", "Auto"],
          type: "string",
          description: "\r\n\r\nOriginal\r\n\r\nOverride\r\n\r\nAuto",
          "x-enumNames": ["Original", "Override", "Auto"],
        },
        ContentManagementTypes: {
          ...
          description: "\r\n\r\n1 = None\r\n\r\n2 = DataSelector\r\n\r\n3 = FormSelector",
          format: "int32",
          "x-enumNames": ["None", "DataSelector", "FormSelector"],
        },
        ContentSecurityAttributes: {
          enum: ["Undefined", "Guest", "Demo"],
          type: "string",
          description: "\r\n\r\nUndefined\r\n\r\nGuest\r\n\r\nDemo",
        ...
        CreateLiveOperatorStreamResponseModel: {
          ...
          properties: {
            ...
            liveOperatorMode: {
              ...
              description: "\r\n\r\nManual\r\n\r\nIVS\r\n\r\nMediaLive\r\n\r\nRealtime",
              "x-enumNames": ["Manual", "IVS", "MediaLive", "Realtime"],
            },
          },
          additionalProperties: false,
        },
        CreatePlaceholderModel: {
          ...
          properties: {
            assetName: {
              ...
              type: "string",
              description:
                "The visual name of the new placeholder. It can contain spaces and other characters,\r\nmust contain file extension",
            },
          },
          additionalProperties: false,
        },
        ...
        EmailTypes: {
          enum: ["AssetRestored", "UserApproved", "CollectionShared", "CollectionSharedExternal", "UserInvite"],
          type: "string",
          description:
            "\r\n\r\nAssetRestored\r\n\r\nUserApproved\r\n\r\nCollectionShared\r\n\r\nCollectionSharedExternal\r\n\r\nUserInvite",
          "x-enumNames": [
        ...
        FaceMatchTypes: {
          enum: ["Automatch", "ProbableMatch", "NotMatch", "ConfirmedMatch", "Blurry"],
          type: "string",
          description: "\r\n\r\nAutomatch\r\n\r\nProbableMatch\r\n\r\nNotMatch\r\n\r\nConfirmedMatch\r\n\r\nBlurry",
          "x-enumNames": ["Automatch", "ProbableMatch", "NotMatch", "ConfirmedMatch", "Blurry"],
        },
        FaceModel: {
          type: "object",
          properties: {
        ...
        LiveOperatorModes: {
          enum: ["Manual", "IVS", "MediaLive", "Realtime"],
          type: "string",
          description: "\r\n\r\nManual\r\n\r\nIVS\r\n\r\nMediaLive\r\n\r\nRealtime",
          "x-enumNames": ["Manual", "IVS", "MediaLive", "Realtime"],
        },
        LiveOperatorStatuses: {
          enum: ["PreRoll", "Running", "CreatingSegment", "Error", "PostRoll", "Starting", "Stopping", "Stopped"],
          type: "string",
          description:
            "\r\n\r\nPreRoll\r\n\r\nRunning\r\n\r\nCreatingSegment\r\n\r\nError\r\n\r\nPostRoll\r\n\r\nStarting\r\n\r\nStopping\r\n\r\nStopped",
          "x-enumNames": [
        ...
        MetadataTypes: {
          ...
          type: "string",
          description:
            "Note that this is a PARTIAL list of types that we need to know about\r\n\r\nDocumentContent\r\n\r\nComprehendKeyPhrases\r\n\r\nComprehendEntities\r\n\r\nRekognitionImageIndexFaces\r\n\r\nRekognitionImageSearchFaces\r\n\r\nRekognitionImageLabels\r\n\r\nRekognitionImageCelebrityRecognition\r\n\r\nRekognitionVideoLabels\r\n\r\nTextractAnalyzeDocument\r\n\r\nTranscribe\r\n\r\nTranscribeVtt\r\n\r\nTranscribeTranslation\r\n\r\nTranscribeVttTranslation\r\n\r\nRekognitionVideoCelebrityRecognition\r\n\r\nRekognitionVideoPersonTracking\r\n\r\nRekognitionVideoFaceDetection\r\n\r\nImageInfo\r\n\r\nTranscode\r\n\r\nClip\r\n\r\nMediaInfo\r\n\r\nRekognitionImageDetectText\r\n\r\nRekognitionImageUnsafeContent\r\n\r\nRekognitionVideoUnsafeContent\r\n\r\nScreenshot\r\n\r\nSageMakerGroundTruthLabelResults\r\n\r\nThumbnailSheet\r\n\r\nThumbnailImage\r\n\r\nSageMakerInvokeEndpointResults\r\n\r\nSageMakerModelLabels\r\n\r\nRekognitionImageCustomLabels\r\n\r\nSageMakerManifest\r\n\r\nPreviewImage\r\n\r\nRekognitionVideoTextDetection\r\n\r\nRekognitionVideoSegmentDetection\r\n\r\nNomadVideoSegmentDetection\r\n\r\nTranscribeMedical\r\n\r\nPreviewAudio\r\n\r\nText\r\n\r\nAssetManifest\r\n\r\nIntervalSegments\r\n\r\nTranscribeMedicalText\r\n\r\nTranscribeMedicalTranslation\r\n\r\nAdobeMetadata\r\n\r\nAdobeMetadataText\r\n\r\nImageExif\r\n\r\nTextractImageDetectText\r\n\r\nAdSegments\r\n\r\nVmap\r\n\r\nVast\r\n\r\nMediaTailorVideo\r\n\r\nTranscribeSrt\r\n\r\nTranscribeRaw\r\n\r\nSubtitles\r\n\r\nVizRtMetadata\r\n\r\nProcessorJobs\r\n\r\nOfficeDocument\r\n\r\nTranscriptionContainer\r\n\r\nComprehendSentiment\r\n\r\nComprehendLanguage\r\n\r\nOriginalSourceVideo\r\n\r\nImportManifest\r\n\r\nTranscribeScc\r\n\r\nTranscribeTtml\r\n\r\nTranscribeDfxp\r\n\r\nTranscribeSmptett\r\n\r\nTranscribeXml\r\n\r\nTranscribeQt\r\n\r\nTranscribeRt\r\n\r\nTranscribeSsa\r\n\r\nTranscribeAss\r\n\r\nTranscribeSbv\r\n\r\nTranscribeSmi\r\n\r\nTranscribeSami\r\n\r\nTranscribeStl\r\n\r\nTranscribeSub\r\n\r\nAssociatedAsset\r\n\r\nMobiusLabsImageLabels\r\n\r\nMobiusLabsVideoLabels",
          "x-enumNames": [
            "DocumentContent",
            "ComprehendKeyPhrases",
            "ComprehendEntities",
        ...
        NodeModel: {
          ...
          properties: {
            ...
            permission: {
              ...
              description: "\r\n\r\nRead\r\n\r\nWrite\r\n\r\nDelete\r\n\r\nAdministrator\r\n\r\nGuest",
              "x-enumNames": ["Read", "Write", "Delete", "Administrator", "Guest"],
            },
            properties: {
              type: "object",
              additionalProperties: {},
        ...
        Permissions: {
          enum: ["Read", "Write", "Delete", "Administrator", "Guest"],
          type: "string",
          description: "\r\n\r\nRead\r\n\r\nWrite\r\n\r\nDelete\r\n\r\nAdministrator\r\n\r\nGuest",
          "x-enumNames": ["Read", "Write", "Delete", "Administrator", "Guest"],
        },
        ...
        PersonSubmitModel: {
          ...
          properties: {
            ...
            matchedFaces: {
              ...
              description:
                "The list of face IDs that match this person. This list contains only changed faces that have become matched.",
              nullable: true,
            },
            unmatchedFaces: {
              type: "array",
              ...
              description:
                "The list of face IDs that do not match this person. This list contains only changed faces that have become not matched.",
              nullable: true,
            },
            blurryFaces: {
              type: "array",
              ...
              description:
                "The list of face IDs that are blurry. This list contains only changed faces that are marked as blurry.",
              nullable: true,
            },
          },
          additionalProperties: false,
        ...
        PingStatuses: {
          enum: ["Normal", "ChatDisabled", "AccountExpired", "SessionDeactivated"],
          type: "string",
          description: "\r\n\r\nNormal\r\n\r\nChatDisabled\r\n\r\nAccountExpired\r\n\r\nSessionDeactivated",
          "x-enumNames": ["Normal", "ChatDisabled", "AccountExpired", "SessionDeactivated"],
        },
        PublishScheduleRequestModel: {
          required: ["numberOfLockedDays"],
          type: "object",
          properties: {
            scheduleId: {
              type: "string",
        ...
        ScheduleItemSearchTypes: {
          enum: ["Random", "RandomWithinDateRange", "Newest", "NewestNotPlayed"],
          type: "string",
          description: "\r\n\r\nRandom\r\n\r\nRandomWithinDateRange\r\n\r\nNewest\r\n\r\nNewestNotPlayed",
          "x-enumNames": ["Random", "RandomWithinDateRange", "Newest", "NewestNotPlayed"],
        },
        ScheduleItemSourceTypes: {
          enum: ["PlaylistSchedule", "SearchFilters", "VideoAsset", "LiveChannel"],
          type: "string",
          description: "\r\n\r\nPlaylistSchedule\r\n\r\nSearchFilters\r\n\r\nVideoAsset\r\n\r\nLiveChannel",
          "x-enumNames": ["PlaylistSchedule", "SearchFilters", "VideoAsset", "LiveChannel"],
        },
        ScheduleItemTypes: {
          enum: ["Asset", "Dynamic"],
          type: "string",
        ...
        ScheduleModel: {
          ...
          properties: {
            ...
            scheduleStatus: {
              ...
              description: "\r\n\r\nNew\r\n\r\nStopped\r\n\r\nStarting\r\n\r\nRunning\r\n\r\nStopping\r\n\r\nError",
              "x-enumNames": ["New", "Stopped", "Starting", "Running", "Stopping", "Error"],
            },
            status: {
              allOf: [
                {
        ...
        ScheduleStatuses: {
          enum: ["New", "Stopped", "Starting", "Running", "Stopping", "Error"],
          type: "string",
          description: "\r\n\r\nNew\r\n\r\nStopped\r\n\r\nStarting\r\n\r\nRunning\r\n\r\nStopping\r\n\r\nError",
          "x-enumNames": ["New", "Stopped", "Starting", "Running", "Stopping", "Error"],
        },
        ScheduleTypes: {
          enum: ["Playlist", "IntelligentSchedule", "IntelligentPlaylist"],
          type: "string",
          description: "\r\n\r\nPlaylist\r\n\r\nIntelligentSchedule\r\n\r\nIntelligentPlaylist",
          "x-enumNames": ["Playlist", "IntelligentSchedule", "IntelligentPlaylist"],
        },
        ...
        SearchModel: {
          ...
          properties: {
            ...
            filterBinder: {
              ...
              description:
                "Tells the query engine of the Filters should be applied as an And or an Or (the default is And)\r\n\r\n0 = And\r\n\r\n1 = Or",
              "x-enumNames": ["And", "Or"],
            },
            sortFields: {
              type: "array",
            ...
            searchResultFields: {
              ...
              description:
                "The list of fields and optionally the sub fields and related records that should be returned as a result",
              nullable: true,
            },
          },
          additionalProperties: false,
        ...
        SecurityPermissions: {
          enum: ["Read", "FileWrite", "FolderWrite", "Administrator", "Guest"],
          type: "string",
          description: "\r\n\r\nRead\r\n\r\nFileWrite\r\n\r\nFolderWrite\r\n\r\nAdministrator\r\n\r\nGuest",
          "x-enumNames": ["Read", "FileWrite", "FolderWrite", "Administrator", "Guest"],
        },
        SegmentModel: {
          type: "object",
          properties: {
        ...
        TagContentModel: {
          ...
          properties: {
            ...
            name: {
              type: "string",
              description:
                "The name of the tag that should be added or removed. If the name and the tagId are both specified, the name is ignored.",
              nullable: true,
            },
            childId: {
              type: "string",
        ...
        UserVideoTrackingModel: {
          ...
          properties: {
            ...
            videoTrackingAttribute: {
              ...
              description: "\r\n\r\nUndefined\r\n\r\nWatchlist",
              "x-enumNames": ["Undefined", "Watchlist"],
            },
            userId: {
              type: "string",
              format: "uuid",
  ...
  "response-enums": {
    ...
    info: {
      ...
      description:
        "This is a demo API definition for our support to supplement response schema descriptions with enums are present.",
      version: "1.0.0",
    },
    servers: [
      {
  ...
  responses: {
    ...
    paths: {
      "/vendor-prefix-content-type": {
        get: {
          description:
            "We should be able to return a response schema on vendor-prefixed content type that's JSON-compatible.",
          responses: {
            "200": {
              description: "OK",
              content: {
      ...
      "/vendored-xml-content-type-suffix": {
        get: {
          description:
            "We should be able to return a response schema on vendor-prefixed content type that's XML-compatible.",
          responses: {
            "200": {
              description: "OK",
              content: {
      ...
      "/multiple-responses-with-a-json-compatible": {
        get: {
          description:
            "We should always prefer a JSON-compatible content type when multiple content types are present in a response.",
          responses: {
            "200": {
              description: "OK",
              content: {
      ...
      "/multiple-responses-with-json-compatible-and-wildcard": {
        get: {
          description:
            "We should always prefer the JSON-compatible content type when both JSON and wildcard content types are present.",
          responses: {
            "200": {
              description: "OK",
              content: {
      ...
      schemas: {
        ...
        Pet: {
          ...
          properties: {
            ...
            category_alt: {
              description:
                "Though this loads a `$ref` to the `Category` schema, and that contains deprecated properties within itself, this `category_alt` parameter is also deprecated.",
              deprecated: true,
              $ref: "#/components/schemas/Category",
            },
            name: {
            ...
            tags_alt: {
              description:
                "Unlike the `tags` parameter, this is **not** deprecated, but the contents within itself are.",
              type: "array",
              items: {
    ...
    components: {
      securitySchemes: {
        apiKey_cookie: {
          ...
          name: "api_key",
          description:
            "An API key that will be supplied in a named cookie. https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.3.md#security-scheme-object",
        },
        apiKey_query: {
          type: "apiKey",
          in: "query",
          name: "apiKey",
          description:
            "An API key that will be supplied in a named query parameter. https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.3.md#security-scheme-object",
        },
      },
    },
  },
  "server-variables": {
    ...
    paths: {
      ...
      "/tables/{tableId}/rows/{rowId}": {
        put: {
          summary:
            "Should be able to match a complex URL that uses a server that has a full hostname as a server variable.",
          parameters: [
            {
              in: "path",
              name: "tableId",
