  ...
  return (
    <Stack gap={3}>
      <Card.Root p={0} m={0} size={'sm'}>
        ...
        <Card.Body p={0} m={0}>
          <Text textStyle="xl" fontWeight="semibold">General</Text>
          <Wrap w={'full'}>
            <Button size={'2xs'}>dereference</Button>
          ...
          <Text textStyle="xl" fontWeight="semibold">Operations</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Servers</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Specification Extensions</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">User Authentication</Text>
          <Wrap w={'full'}>
      ...
      <Card.Root p={0} m={0} size={'sm'}>
        ...
        <Card.Body p={0} m={0}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Callbacks</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Parameters</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Request Body</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Responses</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Security</Text>
          <Wrap w={'full'}>
      ...
      <Card.Root p={0} m={0} size={'sm'}>
        ...
        <Card.Body p={0} m={0}>
          ...
          <Text textStyle="xl" fontWeight="semibold">OpenAPI Features</Text>
          <Wrap w={'full'}>
          ...
          <Text textStyle="xl" fontWeight="semibold">Reducer</Text>
          <Wrap w={'full'}>
