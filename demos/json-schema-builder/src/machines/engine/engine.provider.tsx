...
dataSourceMachine, schemaSourceMachine
...
export const engineMachine = createMachine({
  entry: assign({
    ...
    dataSource: ({ spawn }) => spawn(dataSourceMachine, { systemId: ENGINE_SYSTEM_IDS.DATASOURCE }),
    schemaSource: ({ spawn }) => spawn(schemaSourceMachine, { systemId: ENGINE_SYSTEM_IDS.SCHEMASOURCE }),
