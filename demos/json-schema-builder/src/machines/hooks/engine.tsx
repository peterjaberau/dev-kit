...
export function useEngineActors() {
  ...
  const dataSourceRef = getSpawnedActor(ENGINE_SYSTEM_IDS.DATASOURCE, engineRef)
  const schemaSourceRef = getSpawnedActor(ENGINE_SYSTEM_IDS.SCHEMASOURCE, engineRef)
