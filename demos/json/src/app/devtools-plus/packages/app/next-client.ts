/**
 * Next.js Client Components for React DevTools Plus
 *
 * This entry exports client-side React components that must run in the browser.
 * Import from 'react-devtools-plus/next/client' in your layout.tsx
 */
'use client'
