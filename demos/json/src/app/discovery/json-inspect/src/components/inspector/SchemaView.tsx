  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between text-sm">
        <p className="text-gray-600 dark:text-slate-400">Minimal schema</p>
        <button
          type="button"
          onClick={handleCopy}
      ...
      <pre className="max-h-[480px] overflow-auto rounded-2xl bg-white dark:bg-slate-950/50 p-4 text-xs leading-6 text-gray-900 dark:text-slate-100 shadow-inner border border-gray-200 dark:border-transparent">
        {schemaText}
      </pre>
    </div>
  );
