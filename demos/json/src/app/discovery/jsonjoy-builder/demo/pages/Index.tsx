...
import { JsonValidator } from "#app/discovery/jsonjoy-builder/src";
import { SchemaInferencer } from "#app/discovery/jsonjoy-builder/src";
import JsonSchemaEditor from "../../src/components/SchemaEditor/JsonSchemaEditor";
...
import { TranslationContext } from "../../src/i18n/translation-context";
...
const Index = () => {
  ...
  const handleLanguageChange = (value: string) => {
    setLanguage(value);
    import(`../../src/i18n/locales/${value}`).then((module) => {
