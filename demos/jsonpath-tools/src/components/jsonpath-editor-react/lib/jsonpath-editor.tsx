...
import { DefaultLanguageServices, jsonpath, updateQueryOptionsEffect, updateQueryArgumentEffect, updateQueryArgumentTypeEffect } from "#components/codemirror-lang-jsonpath";
import { AnyDataType, DataType, defaultQueryOptions, JSONValue, QueryOptions } from "#components/jsonpath";
...
export default function JSONPathEditor({
    ...
    return (
        <div ref={containerElementRef} style={style} className={'container'}></div>
    );
}
