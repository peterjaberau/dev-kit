...
function jsonDeepEqualsArrays(valueA: JSONValue[] | any, valueB: JSONValue[] | any): boolean {
...
function jsonDeepEqualsObjects(valueA: { [key: string]: JSONValue; } | any, valueB: { [key: string]: JSONValue; } | any): boolean {
