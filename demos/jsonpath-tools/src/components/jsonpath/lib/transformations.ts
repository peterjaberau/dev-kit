...
function replaceOrRemoveAtPathsRecursive(
    value: JSONValue,
    paths: readonly NormalizedPath[] | any,
    ...
    let newValue: JSONValue | undefined | any = value;
...
function compareNormalizedPaths(pathA: NormalizedPath | any, pathB: NormalizedPath | any): number {
