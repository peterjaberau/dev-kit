...
export const applicationThemeCommon = EditorView.theme({
    "&": { background: "var(--chakra-colors-bg-panel)", color: "var(--chakra-colors-fg)", height: "100%", fontSize: "var(--chakra-font-sizes-sm)" },
    "&.cm-focused": { outline: "none" },
    "& .cm-content": { fontFamily: "var(--chakra-fonts-mono)", paddingLeft: "2px", paddingRight: "2px" },

    // Lines.
    "& .cm-activeLine": { backgroundColor: "transparent", outline: "2px solid var(--chakra-colors-gray-100)" },
    "& .cm-gutters": { fontFamily: "var(--chakra-fonts-mono)", backgroundColor: "var(--chakra-colors-bg-panel)", borderRight: "none", padding: "0 5px 0 5px" },
    "& .cm-lineNumbers .cm-gutterElement": { color: "var(--chakra-colors-fg-muted)" },
    "& .cm-lineNumbers .cm-gutterElement.cm-activeLineGutter": { color: "var(--chakra-colors-fg)" },
    "& .cm-gutterElement.cm-activeLineGutter": { backgroundColor: "transparent" },
    "& .cm-line": { padding: "0 2px 0 0" },

    // Selection.
    "& .cm-selectionBackground": { background: "var(--chakra-colors-bg-subtle)" },
    "&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground": { background: "var(--chakra-colors-fg)" },
    ...
    "& .cmjp-tooltip-signatureHelp-signature": { fontFamily: "var(--chakra-fonts-mono)" },
