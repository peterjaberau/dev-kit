import { Accordion, AccordionItem, ActionIcon, DropdownMenu, Icon } from "@devkit/ui"
    ...
    <Flexbox gap={24} style={{ width: "100%" }}>
          ...
          <AccordionItem
            action={
              <Flexbox gap={4} horizontal>
                <ActionIcon icon={Edit} onClick={() => console.log("Edit clicked")} size="small" title="Edit" />
                <ActionIcon
                  icon={Settings}
                  onClick={() => console.log("Settings clicked")}
                  size="small"
      ...
      <div style={{ width: "100%" }}>
        ...
        <Accordion style={{ width: "100%" }}>
          <AccordionItem
            action={<ActionIcon icon={Settings} size="small" title="Borderless variant" variant="borderless" />}
          ...
          <AccordionItem
            action={<ActionIcon icon={Settings} size="small" title="Filled variant" variant="filled" />}
          ...
          <AccordionItem
            action={<ActionIcon icon={Settings} size="small" title="Outlined variant" variant="outlined" />}
