...
```tsx
import { ColorScales, primary } from '@devkit/ui/color';
...
```tsx
import { ColorScales, red } from '@devkit/ui/color';
...
```tsx
import { ColorScales, volcano } from '@devkit/ui/color';
...
```tsx
import { ColorScales, orange } from '@devkit/ui/color';
...
```tsx
import { ColorScales, gold } from '@devkit/ui/color';
...
```tsx
import { ColorScales, yellow } from '@devkit/ui/color';
...
```tsx
import { ColorScales, lime } from '@devkit/ui/color';
...
```tsx
import { ColorScales, green } from '@devkit/ui/color';
...
```tsx
import { ColorScales, cyan } from '@devkit/ui/color';
...
```tsx
import { ColorScales, blue } from '@devkit/ui/color';
...
```tsx
import { ColorScales, geekblue } from '@devkit/ui/color';
...
```tsx
import { ColorScales, purple } from '@devkit/ui/color';
...
```tsx
import { ColorScales, magenta } from '@devkit/ui/color';
...
```tsx
import { ColorScales, gray } from '@devkit/ui/color';
...
```tsx
import { ColorScales, mauve } from '@devkit/ui/color';
...
```tsx
import { ColorScales, olive } from '@devkit/ui/color';
...
```tsx
import { ColorScales, sage } from '@devkit/ui/color';
...
```tsx
import { ColorScales, sand } from '@devkit/ui/color';
...
```tsx
import { ColorScales, slate } from '@devkit/ui/color';
