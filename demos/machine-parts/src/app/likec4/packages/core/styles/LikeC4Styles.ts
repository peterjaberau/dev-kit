...
export class LikeC4Styles {
  ...
  static from(stylesConfig: LikeC4ProjectStylesConfig | undefined, customColors?: CustomColorDefinitions | undefined) {
  ...
  private compoundColorsCache = new DefaultWeakMap(
