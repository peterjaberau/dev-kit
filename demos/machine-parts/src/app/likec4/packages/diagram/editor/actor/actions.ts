...
export const isLayoutChange = (change: t.ViewChange): change is LayoutChanges =>
  change.op === "reset-manual-layout" || change.op === "save-view-snapshot"

export const isLayoutChangeOp = <T extends SyncOp>(op: T): op is Extract<T, string | LayoutChanges> =>
