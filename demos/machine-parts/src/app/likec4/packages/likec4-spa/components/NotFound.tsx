...
const ChakraContainer = chakra(Container) as any
const ChakraText = chakra(Text) as any
const ChakraTitle = chakra(Title) as any
...
export function NotFound() {
  ...
  return (
    <ChakraContainer css={classes.root}>
      <chakra.div css={classes.inner}>
        <chakra.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362 145" css={classes.image}>
          <path
            fill="currentColor"
        ...
        <chakra.div css={classes.content}>
          <ChakraTitle css={classes.title}>Nothing to see here</ChakraTitle>
          <ChakraText c="dimmed" size="lg" ta="center" css={classes.description}>
