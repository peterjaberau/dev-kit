    ...
    steps: [
      ...
      },
      {
        ...
        view: {
          ...
          actions: [{ type: "button", label: "Continue", event: "NEXT" }],
        },
      },
    ],
  },
    ...
    steps: [
      {
        ...
        view: {
          ...
          message:
            "This demo showcases the complete XFlows framework with React integration, form handling, API calls, and state management.",
          actions: [
            {
              type: "button",
              label: "Get Started",
      ...
      },
      {
        ...
        view: {
          ...
          message:
            "This step demonstrates how XFlows handles async operations and API calls. Click the button to simulate an API request.",
          actions: [
            {
              type: "button",
      ...
      },
      {
        ...
        view: {
          ...
          message:
            "You've successfully completed the XFlows demo! This showcases form handling, state management, navigation, and API integration.",
          actions: [
            {
              type: "button",
              label: "Start Over",
            ...
            actions: [
              {
                ...
                props: {
                  ...
                  riskLevel:
                    "{{context.session.riskIndex > 0.7 ? 'high' : context.session.riskIndex > 0.4 ? 'medium' : 'low'}}",
                },
              },
            ],
          },
          ...
          before: [
            {
              ...
              type: "condition",
              expression: {
                and: [{ var: "firstName" }, { var: "lastName" }, { var: "email" }],
              },
              onTrue: [
                {
                  id: "log-validation",
