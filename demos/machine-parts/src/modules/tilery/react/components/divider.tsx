...
import type { TileryDivider as DividerType, TilerySizeResolutionContext } from "#tilery/core/internal"
import { tileryRectEdgePercent } from "#tilery/core/internal"
...
export type DividerProps = {
   ...
   */
  onReset?: (dividerId: string, sizeContext?: TilerySizeResolutionContext) => boolean | void
...
export const TileryDivider = memo(function TileryDivider({
  ...
  const onMove = useCallback(
    (e: React.PointerEvent) => {
      ...
      const pct = tileryRectEdgePercent(rect, e.clientX, e.clientY, divider.orientation === "vertical" ? "left" : "top")
