/**
 * jalco-ui
 * Sample log generators for LogViewer demos.
 */

import type { LogEntry, LogLevel } from "@/components/kidow/log-viewer/log-viewer"
 ...
 */
export function generateSampleLogs(count: number, seed: number = 42): LogEntry[] {
  let s = seed
...
export const DEPLOY_LOG: LogEntry[] = [
  ...
  {
    level: "warn",
    message: "Type warning: unused variable 'tempData' in utils.ts:42",
    timestamp: "2026-03-11T14:00:18.100Z",
  },
  ...
  {
    level: "info",
    message: "✓ Deployment successful — https://app.example.com",
    timestamp: "2026-03-11T14:00:43.200Z",
  },
]
