...
export const DOCK_PANELS: PanelDescriptor[] = [
  { id: "dock-settings", title: "Dock Settings", scope: "dock" },
  { id: "log", title: "Commits", scope: "dock" },
  {
  ...
  { id: "console", title: "Git Console", scope: "dock" },
  {
    id: "git-log",
...
export const ALL_PANELS = [...GLOBAL_PANELS, ...DOCK_PANELS]
...
export const DOCKVIEW_TAB_COMPONENTS = TAB_COMPONENTS
...
export const DOCKVIEW_COMPONENTS: Record<string, FunctionComponent<IDockviewPanelProps>> = {
