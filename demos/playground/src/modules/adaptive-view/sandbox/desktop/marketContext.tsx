...
const INITIAL_PRICES: Record<string, number> | any = {
    'BTC/USD': 67432.5,
    'AAPL': 182.5,
    'MSFT': 415.2,
    'NVDA': 875.4,
...
function reducer(state: MarketState, action: MarketAction): MarketState {
    switch (action.type) {
        ...
        case 'TICK': {
            const newPrices: any = { ...state.prices };
