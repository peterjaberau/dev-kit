...
export function getPanelConfig<TConfig = unknown>(panelId: string): any | undefined {
  return configs.get(panelId) as any | undefined
}
...
export function setPanelConfig(panelId: string, next: any): void {
 ...
 */
export function ensurePanelConfig(panelId: string, seed: any) {
  if (!configs.has(panelId)) {
    configs.set(panelId, seed)
    // notify(panelId)
    return seed
  }
  return configs.get(panelId)
}
 ...
 */
export function usePanelConfig<TConfig>(panelId: string): any | undefined {
