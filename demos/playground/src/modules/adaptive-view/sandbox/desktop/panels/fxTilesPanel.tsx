...
import { useDesktopColors, useDockviewTheme } from "#adaptive-view/sandbox/desktop/providers";
...
const CATEGORIES: { id: string; label: string; pairs: Pair[] }[] | any[] = [
    {
        id: 'g10',
        label: 'G10',
        pairs: [
