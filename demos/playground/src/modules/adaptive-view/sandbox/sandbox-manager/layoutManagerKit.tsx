...
import {
    LM,
    layoutManagerBtn,
    layoutManagerBtnActive,
    layoutManagerIconBtn,
} from './layoutManagerTheme';

// A small design-system for the "Controls & Theme" layout manager, built on the
...
export const Slider: React.FC<{
    ...
    return (
        ...
        >
            ...
            <input
                type="range"
                className="dv-layout-manager-slider"
                min={min}
                max={max}
                step={step}
                value={value}
...
export const Segmented: React.FC<{
    ...
    >
        {label && (
            <span
                style={{ flex: 1, fontSize: 12, color: LM.text, fontFamily: LM.ui }}
            >
                {label}
            </span>
        )}
...
export const Switch: React.FC<{
    ...
    >
        {icon && (
            <span
                className="material-symbols-outlined"
                style={{ fontSize: 18, color: LM.muted }}
            >
                {icon}
            </span>
        )}
...
export const Btn: React.FC<{
    ...
    <button
        ...
        title={title}
        style={{
            ...(primary ? layoutManagerBtnActive : layoutManagerBtn),
            display: 'inline-flex',
            alignItems: 'center',
            justifyContent: 'center',
            gap: 5,
...
export const IconBtn: React.FC<{
    ...
    <button
        onClick={onClick}
        title={title}
        style={active ? layoutManagerBtnActive : layoutManagerIconBtn}
    >
