...
export const SANDBOX_DARK_COLORS: SandboxColors = {
    isDark: true,
    bg: '#06090f',
    bgAlt: '#04060c',
...
export const SANDBOX_LIGHT_COLORS: SandboxColors = {
    isDark: false,
    bg: '#ffffff',
    bgAlt: '#f8fafc',
...
export const SandboxColorsContext = React.createContext<SandboxColors>(
    SANDBOX_DARK_COLORS
);
export const useSandboxColors = () => React.useContext(SandboxColorsContext);
