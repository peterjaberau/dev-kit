...
import type { ViewEdge, ViewPanelId, ViewSizeResolutionContext } from "../../core/internal"
...
export type EdgeResizeHandleProps = {
   ...
   * the handle element.
   */
  placementStyle?: React.CSSProperties | any;
  /**
...
export function EdgeResizeHandle({
  ...
  const onMove = useCallback(
    (e: React.PointerEvent) => {
      ...
      const size = viewRectEdgePercent(rect, e.clientX, e.clientY, side);
  ...
  return (
    <div
      className="view__edge-resize-handle"
