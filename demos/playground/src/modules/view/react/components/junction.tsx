...
/**
 * Props for the {@link ViewJunction} component.
 */
 ...
 */
export const ViewJunction = memo(function ViewJunction({
  junction,
  disabled = false,
  ...
  const onMove = useCallback(
    (e: React.PointerEvent) => {
      ...
      onDrag(
        junction.id,
        viewRectEdgePercent(rect, e.clientX, e.clientY, 'left'),
        viewRectEdgePercent(rect, e.clientX, e.clientY, 'top'),
        'pointer',
