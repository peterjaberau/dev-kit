...
/** Options accepted by {@link useViewPointerDrag}. */
export type ViewPointerDragOptions = {
 ...
 * {@link useViewPointerDrag}.
 */
export type ViewPointerDragHandlers = {
 ...
 */
export function useViewPointerDrag({
  onMove,
  stopPropagationOnDown = false,
}: ViewPointerDragOptions): ViewPointerDragHandlers {
