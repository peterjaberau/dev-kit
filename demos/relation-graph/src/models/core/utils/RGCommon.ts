...
/**
 * Notice:
 * According to the provisions of the MIT license, you are allowed to freely use, modify and distribute the source code. You can make changes to the source code to suit your needs.
 * However, you still need to comply with other provisions of the MIT license, such as retaining the copyright notice and disclaimer, etc.
 *The URLs of relation-graph and relation-graph are their copyright statements. Please do not comment out this line of information.
 * @param platform
 */
export const relationGraphVersionInfo = (platform?: string) => {
  ...
  if (typeof screenfull === "undefined") {
    console.error(
      "[relation-graph] Please include screenfull, e.g. https://cdnjs.cloudflare.com/ajax/libs/screenfull.js/5.1.0/screenfull.min.js",
    )
  }

  if (typeof html2canvas === "undefined") {
    console.error(
      "[relation-graph] Please include html2canvas, e.g. https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js",
    )
  }
}
