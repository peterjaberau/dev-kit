...
import '#react-sigma/graph-search/assets/index.css';
...
import jsonGraph from '../../../../public/data/dataset.json';
...
const GraphSearchDemo: FC<{ style?: CSSProperties }> = ({ style }) => {
...
export default GraphSearchDemo
