...
export const getData: any = (state: JsonFormsState) =>
  extractData(get(state, 'jsonforms.core') as any);
export const getSchema = (state: JsonFormsState): JsonSchema =>
  extractSchema(get(state, 'jsonforms.core') as any);
export const getUiSchema = (state: JsonFormsState): UISchemaElement =>
  extractUiSchema(get(state, 'jsonforms.core') as any);
export const getAjv: any = (state: JsonFormsState): Ajv =>
  //@ts-ignore
  extractAjv(get(state, 'jsonforms.core') as any);
export const getRenderers = (
  state: JsonFormsState
): JsonFormsRendererRegistryEntry[] => get(state, 'jsonforms.renderers') as any;
export const getCells = (
  state: JsonFormsState
): JsonFormsCellRendererRegistryEntry[] => get(state, 'jsonforms.cells') as any;
export const getUISchemas = (
  state: JsonFormsState
): JsonFormsUISchemaRegistryEntry[] => get(state, 'jsonforms.uischemas') as any;
