...
export function defaultDataProps(category: string, allFormInputs: { [key: string]: any }): any {
  return allFormInputs[category].defaultDataSchema as any
}

export function defaultUiProps(category: string, allFormInputs: { [key: string]: any }): any {
  return allFormInputs[category].defaultUiSchema as any
}
export function categoryType(category: string, allFormInputs: { [key: string]: any }): any {
  return allFormInputs[category].type
}
export function getCardBody(category: string, allFormInputs: { [key: string]: any }) {
  return (allFormInputs[category] && allFormInputs[category].cardBody) || (() => null)
}

export function categoryToNameMap(allFormInputs: { [key: string]: any }): { [key: string]: string } {
...
function updateElementNames(elementArray: Array<any>) {
...
export function generateCategoryHash(allFormInputs: { [key: string]: any }) {
...
export function getCardCategory(cardProps: any, categoryHash: { [key: string]: string }): string {
  const currentHash = `type:${cardProps.dataOptions.type || ""};widget:${cardProps.uiOptions["ui:widget"] || ""};field:${cardProps.uiOptions["ui:field"] || ""};format:${
...
export function checkForUnsupportedFeatures(schema: { [key: string]: any }, uischema: { [key: string]: any }, allFormInputs: { [key: string]: any }): string[] {
  // add each unsupported feature to this array
...
function generateDependencyElement(
  ...
  if (elementDetails.type && elementDetails.type === "object") {
    ...
    newElement.dataOptions!.category = getCardCategory(newElement as any, categoryHash)
...
export function generateUiSchemaFromElementProps(elementArr: Array<any>, definitionUi: any): { [key: string]: any; definitions?: { [key: string]: any } } {
  if (!elementArr) return {}
...
export function getCardParameterInputComponentForType(category: string, allFormInputs: { [key: string]: any }): any {
...
function getIdFromElementsBlock(elements: Array<any>) {
...
export function generateElementComponentsFromSchemas(parameters: {
  ...
  const schema = JSON.parse(stringify(schemaData))
  const uischema = JSON.parse(stringify(uiSchemaData))
...
function propagateElementChange(elementArr: any[], definitionData: { [key: string]: any }, definitionUi: { [key: string]: any }, categoryHash: { [key: string]: string }) {
...
export function getNewElementDefaultDataOptions(i: number, mods?: any): any {
