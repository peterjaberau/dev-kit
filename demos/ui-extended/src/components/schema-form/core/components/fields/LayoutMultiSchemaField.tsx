...
>(props: FieldProps<T, S, F>) {
  ...
  const onOptionChange = (opt?: unknown) => {
    ...
    let newFormData: any = schemaUtils.sanitizeDataForNewSchema(newOption, oldOption, formData);
    if (newFormData && newOption) {
      // Call getDefaultFormState to make sure defaults are populated on change.
      newFormData = schemaUtils.getDefaultFormState(newOption, newFormData, 'excludeObjectChildren') as any;
    }
    if (newFormData) {
