...
import { getTemplate, getUiOptions, orderProperties, ErrorSchema, FieldProps, FormContextType, GenericObjectType, IdSchema, RJSFSchema, StrictRJSFSchema, TranslatableString, ADDITIONAL_PROPERTY_FLAG, PROPERTIES_KEY, REF_KEY, ANY_OF_KEY, ONE_OF_KEY } from '@/components/module-rjsf/rjsf-utils';
 ...
 */
class ObjectField<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any> extends Component<FieldProps<T, S, F>, ObjectFieldState> {
      ...
      return (
        <div>
          <p className="config-error" style={{ color: 'red' }}>
            <Markdown>{translateString(TranslatableString.InvalidObjectField, [name || 'root', (err as Error).message])}</Markdown>
          </p>
