...
import { createErrorHandler, CustomValidator, ErrorTransformer, FormContextType, getDefaultFormState, getUiOptions, PROPERTIES_KEY, RJSFSchema, RJSFValidationError, StrictRJSFSchema, toErrorSchema, UiSchema, unwrapErrorHandler, validationDataMerge, ValidatorType } from '@/components/module-rjsf/rjsf-utils';
 ...
 */
export function transformRJSFValidationErrors<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>(errors: ErrorObject[] = [], uiSchema?: UiSchema<T, S, F>): RJSFValidationError[] {
