...
import { useInRouterContext, createHashRouter, RouterProvider, FutureConfig } from "react-router-dom"
...
const DummyRouter = ({ children }: { children: ReactNode; basename?: string }) => <>{children}</>
...
const InternalRouter = ({ children, basename = "" }: { children: ReactNode; basename?: string | any } | any) => {
