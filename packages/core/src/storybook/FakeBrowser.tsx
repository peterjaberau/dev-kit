 ...
 * export default {
 *     title: '@dev-kit/core/Admin/CustomRoutes/Authenticated',
 ...
 * };
 */
export const FakeBrowserDecorator = (Story: any, context: any) => {
    return (
...
export const Browser = ({ children }: { children: React.ReactNode }) => {
    return (
        <>
            <style
