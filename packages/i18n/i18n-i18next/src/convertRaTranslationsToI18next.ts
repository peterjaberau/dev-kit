 ...
 * @param raMessages The translations to convert. This is an object as found in packages such as @dev-kit/language-english.
 ...
 *
 * @example Convert the english translations from @dev-kit/language-english to i18next format
 * import englishMessages from '@dev-kit/language-english';
 * import { convertRaTranslationsToI18next } from '@dev-kit/i18n-18next';
 *
 * const messages = convertRaTranslationsToI18next(englishMessages);
 *
 * @example Convert the english translations from @dev-kit/language-english to i18next format with custom interpolation wrappers
 * import englishMessages from '@dev-kit/language-english';
 * import { convertRaTranslationsToI18next } from '@dev-kit/i18n-18next';
 *
 * const messages = convertRaTranslationsToI18next(englishMessages, {
...
export const convertRaTranslationsToI18next = (
    ...
    return Object.keys(raMessages).reduce((acc: any, key: any) => {
 ...
 * import { convertRaTranslationToI18next } from '@dev-kit/i18n-18next';
 *
